       ...
       return (
         <div className="scanner-container">
           ...
           <header className="mb-8 text-center">
             ...
             <p className="text-gray-600 mt-2">Scan and extract credit card details securely and efficiently</p>
           </header>
           ...
           {isLoading && (
             <div className="flex items-center justify-center mb-8">
               ...
               <p className="text-indigo-600 text-lg">Processing your images...</p>
             </div>
           )}
           ...
           {showWebcam && (
             <div className="mb-8">
               <Webcam
                 ...
                 className="webcam-feed w-full max-w-md mx-auto"
                 videoConstraints={{
             ...
             <div className="bg-white p-6 rounded-xl shadow-lg border-t-4 border-indigo-500">
               ...
               <div className="mb-6">
                 <p className="text-gray-700 flex items-center">
                   <strong className="mr-2">Total Processing Time:</strong> {totalProcessingTime.toFixed(2)} seconds
